...
<head>
	...
	<link rel="stylesheet" href="{{ URL::asset('public/asset/vendor/chartist/css/chartist.min.css')}}')}}">
    <link href="{{ URL::asset('public/asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
	<link href="{{ URL::asset('public/asset/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{ route('shipments.index') }}">shipments</a></li> <br>
				...
				<div class="copyright">
					<p> Admin Dashboard <br/>© 2023 All Rights Reserved</p>
					<p class="op5">Made with <span class="heart"></span> by Cyfamod Technologies</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://cyfamod.com/" target="_blank">Cyfamod Technologies</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
	...
	<!-- <script src="{{ URL::asset('public/asset/vendor/chart.js/Chart.bundle.min.js')}}"></script> -->
	<script src="{{ URL::asset('public/asset/vendor/bootstrap-datetimepicker/js/moment.js')}}"></script>
	<script src="{{ URL::asset('public/asset/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
	<!-- Apex Chart -->
	<script src="{{ URL::asset('public/asset/vendor/apexchart/apexchart.js')}}"></script>
	<!-- Chart piety plugin files -->
    <script src="{{ URL::asset('public/asset/vendor/peity/jquery.peity.min.js')}}"></script>	
	<!-- Dashboard 1 -->
	<script src="{{ URL::asset('public/asset/js/dashboard/dashboard-1.js')}}"></script>
	
    <script src="{{ URL::asset('public/asset/js/custom.min.js')}}"></script>
	<script src="{{ URL::asset('public/asset/js/deznav-init.js')}}"></script>
	<!-- <script src="{{ URL::asset('public/asset/js/demo.js')}}"></script> -->
    <script src="{{ URL::asset('public/asset/js/styleSwitcher.js')}}"></script>
</body>
